...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>HES| GRI Results View </title>
                                ...
                                <div class="tools">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2 extra-buttons">
                                            ...
                                            <button class="btn grey-steel uppercase bold" type="button" onclick="location.href = '<?php echo $base_url ?>gri/results'">Reset Search</button>
                                        </div>
                                    </div>
                                    <span id="loader"></span>
                                </div>
                                        ...
                                        <div class="portlet light portlet-fit bordered">
                                            <div class="portlet-title">
                                                <div class="row alert alert-info">
                                                    ...
                                                    <div class="col-md-3"><h3>ID Number
                                                            <span class="label label-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                        </h3></div> 
                                                    <div class="col-md-3"><h3>GRI Score
                                                            <span class="label label-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                        </h3></div> 
                                                    <div class="col-md-3"><h3>GRI Outcome
                                                            <span class="label label-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                        </h3></div> 
                                                </div>
                                            </div>
