                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">OVC Manager</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">

                                    <div class="table-toolbar bottom-up">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="help-block"><a href="<?php echo $base_url; ?>ovc/download/<?php echo $file_name; ?>">Download Sample</a></p>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <!-- <div class="col-md-2">
                                                 <div class="btn-group bottom-left">
                                                    <a   data-toggle="modal" href="#responsive" class="btn green">Single Entry
                                ...
                                <table class="table table-striped table-bordered table-hover" id="ovcs">
                                    <thead>
                                        <tr>
                                            <th>ID</th>                                
                                            <th>OVC Name</th>                                            
                                    ...
                                    <tbody>    
                                        <?php foreach ($ovcs as $key=>$value): ?>
                                            <tr>
                                             <td><?php echo $value->ovc_id?></td>
                                             <td><?php echo $value->first_name.' '.$value->middle_name.' '.$value->surname; ?></td>
                                             <td><?php echo $value->dob ?></td>                                             
                                             <td><?php echo $value->gender ?></td>
                                             <td><?php echo $this->tabledata->getSingleRecord('cbo_table',array('id'=>$value->cbo_id),'cbo_name'); ?></td>
                                             <td><?php 
                                             $fname=$this->tabledata->getSingleRecord('caregivers',array('id'=>$value->caregiver_id),'first_name');
                                              $mname=$this->tabledata->getSingleRecord('caregivers',array('id'=>$value->caregiver_id),'middle_name');
                                             echo $fname.' '.$mname;?></td>
                                             <td><?php echo $value->hiv_status?></td>
                                             <td><?php echo $value->exit_status?></td>
                                             <!--<td>
                                               <a href="<?php //echo $base_url?>ovc/edit_ovc_account/<?php //echo $this->utility->encode($value->id)?>" class="btn btn-outline btn-circle btn-xs purple">
                                                            <i class="fa fa-edit"></i></a>  
                                                <a href="<?php //echo $base_url?>ovc/deactivate_ovc/<?php //echo $this->utility->encode($value->id)?>" class="btn btn-outline btn-circle btn-xs red">
...
$(document).ready(function() {
    ...
    table = $('#ovcs').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('ovc/ajax_list')?>",
            "type": "POST"
        },
