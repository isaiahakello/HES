...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>HES | Deactivate/Activate</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Account Status</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-sunglo bold uppercase"><?php echo sprintf(lang('deactivate_subheading'), $user->username);?></span>
                                                ...
                                                <?php echo form_open("auth/deactivate/".$user->id,'class="form-horizontal"');?>
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Proceed?</label>
                                                            <div class="col-md-4">
