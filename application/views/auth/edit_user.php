                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        <li>
                         ...
                         <li>
                            <a href="<?php echo $base_url?>auth/user_accounts">Users</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
 ...
 <label class="col-md-3 control-label">User Group</label>
      ...
      <?php echo form_hidden($csrf); ?>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="identity" value="<?php echo $user->username;?>">
                                                                
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                            <label class="col-md-3 control-label">Password(if changing password) </label>
                                                            <div class="col-md-4">
                                                                <input type="password" class="form-control" name="password" placeholder="Enter Password">
                                                                <span class="help-block"> Password must be a minimum of 8 characters. </span>
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                            <label class="col-md-3 control-label">Confirm Password(if changing password) </label>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-4">
                                                                ...
                                                                <a  href="<?php echo $base_url ?>auth_admin/user_accounts" type="button" class="btn default">Cancel</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php echo form_close();?>
