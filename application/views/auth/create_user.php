                            ...
                            <div class="portlet light bordered">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="icon-plus"></i>
                                                    <span class="caption-subject font-red-sunglo bold uppercase">Create New User</span>
 ...
 <label class="col-md-3 control-label">User Group</label>
      ...
      <?php endif ?>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="password_confirm" placeholder="Confirm Password">
