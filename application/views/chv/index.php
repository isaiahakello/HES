                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">CHV Manager</span>
                                </div>
                                <div class="tools"> <div class="btn-group">
                                        <a  data-toggle="modal" href="#responsive" class="btn green">ADD CHV
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="chvs">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>CHV Names</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add CHV</h4>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control input-circle" name="cbo_name" >
                                        </div>
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control input-circle" name="county" id="county" onChange="getConstituencies(document.getElementById('county').value)">
...
$(document).ready(function() {
    ...
    table = $('#chvs').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('chv/ajax_list')?>",
            "type": "POST"
        },
...
function load_modal()
{
    ...
    $('.modal-title').text('Add CHV'); // Set Title to Bootstrap modal title

}

function edit_chv(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('chv/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function save()
{
    ...
    if(save_method === 'add') {
        url = "<?php echo site_url('chv/ajax_add')?>";
    } else {
        url = "<?php echo site_url('chv/ajax_update')?>";
    }
...
function delete_chv(id)
{
    if(confirm('Are you sure delete this CHV?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('chv/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
