 ...
 */
$config['site_title']                 = "HES MIS";       // Site Title, example.com
$config['admin_email']                = "julius.gitonga@plan-international.org"; // Admin Email, admin@example.com
$config['default_group']              = 'clerks';           // Default group, use name
