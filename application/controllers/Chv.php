...
class Chv extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('hes_model','chv_model'));
    ...
    public function index() {
        ...
        if ($this->input->post('upload')) {
            $this->hes_model->upload_chv();
        } else {
            // set the flash data error message if there is one
            $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
            $this->data['username'] = $this->ion_auth->user()->row()->username;
            $this->data['chvs'] = $this->tabledata->selectRecords(array(), 'chw_table', array());
            ...
            $this->data['file_name'] = 'chv_upload_sample.xls';
            $this->_render_page('chv/index', $this->data);
        }
    }
    ...
    public function ajax_list() {
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->chv_model->count_all(),
            "recordsFiltered" => $this->chv_model->count_filtered(),
            "data" => $data,
        );
    ...
    public function ajax_edit($id) {
        $data = $this->chv_model->get_by_id($id);
    ...
    function download() {
        ...
        $name = 'chv_upload_sample.xls';
        $data = file_get_contents("./resources/downloads/chv_upload_sample.xls"); // Read the file's contents
