...
class Auth extends CI_Controller {
    ...
    public function index() {
       ...
       redirect('auth_admin');
         ...
         elseif ($this->ion_auth->in_group('clerks'))
         {
         redirect('auth_clerk');
        }
        else {
    ...
    {
        $this->data['message']=$this->session->set_flashdata('message','The application has been locked');
        $this->data['full_names']=$this->ion_auth->user()->row()->first_name.' '.$this->ion_auth->user()->row()->last_name;
    ...
    public function activate($id, $code = FALSE) {
        ...
        if ($activation) {
            ...
            $this->session->set_flashdata('message', $this->ion_auth->messages());
            redirect("auth_admin/user_accounts", 'refresh');
        } else {
